...
Ejemplo_comienzo.obj: ../Ejemplo_comienzo.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv5/tools/compiler/c6000_7.4.4/bin/cl6x" -mv64+ --abi=coffabi -g --include_path="C:/ti/ccsv5/tools/compiler/c6000_7.4.4/include" --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="Ejemplo_comienzo.pp" -mg $(GEN_OPTS__FLAG) "$<"
